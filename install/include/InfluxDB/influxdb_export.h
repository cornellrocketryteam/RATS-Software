...
#      define INFLUXDB_EXPORT __attribute__((visibility("default")))
#    else
...
#    define INFLUXDB_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef INFLUXDB_DEPRECATED
#  define INFLUXDB_DEPRECATED __attribute__ ((__deprecated__))
#endif
